...
public class
RegistrationForm extends JFrame implements ActionListener{
...
gender.equals(""))JOptionPane.showMessageDialog(idField,  "Fields will not be blank"); 
                                     ...
                                     list.add(new
User(idField.getText(), nameField.getText(), gender,
...
null;
                             ...
                             User str = list.get(list.size()
- 1); 


                             String string =
str.uid + "," + str.uname + "," + str.gender +
"," + str.uaddress + "," +
...
gender,String address,String contact) {
